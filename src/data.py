...
if not hasattr(_SingleProcessDataLoaderIter, "next"):
    _SingleProcessDataLoaderIter.next = _SingleProcessDataLoaderIter.__next__

if not hasattr(_MultiProcessingDataLoaderIter, "next"):
    _MultiProcessingDataLoaderIter.next = _MultiProcessingDataLoaderIter.__next__
